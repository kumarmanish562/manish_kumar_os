        ...
        <div ref={containerRef} className="min-h-[85vh] w-full px-4 lg:px-8 pb-20 pt-10">
            <div className="max-w-5xl mx-auto space-y-16">
                ...
                <div className="page-header text-center space-y-4">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-900/20 border border-purple-500/30 text-purple-300 font-mono text-xs">
                        <Terminal size={12} />
                        ...
                        {experience.map((exp, idx) => (
                            <div key={idx} className="relative grid grid-cols-1 md:grid-cols-[auto_1fr] gap-8 group">
                                ...
                                <div className="timeline-node absolute left-0 md:relative md:left-auto flex flex-col items-center">
                                    <div className="w-8 h-8 rounded-full bg-[#0a0a0a] border-2 border-cyan-500 shadow-[0_0_15px_rgba(0,243,255,0.4)] flex items-center justify-center z-10 group-hover:scale-110 transition-transform duration-300">
                                ...
                                <div className="experience-card pl-10 md:pl-0">
                                    <div className="relative p-6 md:p-8 rounded-3xl bg-[#0f121a]/80 backdrop-blur-xl border border-white/5 group-hover:border-cyan-500/30 transition-all duration-300 shadow-xl overflow-hidden">
                                        ...
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 border-b border-white/5 pb-4">
                                            ...
                                            <div className="flex items-center gap-2 px-3 py-1 rounded-lg bg-white/5 border border-white/10 text-gray-400 text-xs font-mono">
                                                <Calendar size={14} />
                                                {exp.date}
                                            </div>
                                        </div>
                                            ...
                                            {exp.technologies && (
                                                <div className="flex flex-wrap gap-2 pt-2">
                                                    {exp.technologies.map((tech, i) => (
                                                        <span
                                                            key={i}
                                                            className="flex items-center gap-1 px-2.5 py-1 rounded-md bg-cyan-950/30 border border-cyan-500/20 text-cyan-300 text-xs font-mono hover:bg-cyan-900/50 transition-colors"
                                                        >
